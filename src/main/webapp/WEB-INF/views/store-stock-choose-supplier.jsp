...
function closeWin(choosingItem)
{
	...
	window.opener.document.getElementById("myParentSup").value= choosingItem;
	window.close();
}
...
<div class="row">
	<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
		<div class="input-group"> <!-- to combine search & input box -->
			...
			<input type="text"  class="form-control" id="inputSearch" onkeyup="mySearchFunction()" placeholder="Enter Supplier">
		</div>	
	</div>
</div>
...
<div class="row">
	<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
		<table class="table table-bordered" id="myTable">
			<c:forEach items="${supplierLists}" var="supp">
				<tr>
					<td><a href="${pageContext.request.contextPath}/store/stock/after/choosedItem" onclick="closeWin('${supp.supName}')"><label>${supp.supName}</label></a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
